...
BIP: 182
Layer: Peer Services
Title: Transaction and block validation using the Utreexo accumulator
...
The accompanying accumulator proof proves that the given leaf datas are committed
...
occurances of these outputs, the leaves representing the corresponding first UTXOs in the Utreexo accumulator
...
This is because fetching and storing the UTXOs are random disk reads and writes, the slowest part of a disk opeartion.
